...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var noId = document.getElementById('no_id');
  var noPw = document.getElementById('no_pw');
  var noAll = document.getElementById('no_all');
  var noInfo = document.getElementById('no_info');
  ...
  var nonMember = document.getElementById('nonmember');
  var nonmemberOrder = document.getElementById('nonmember_order');
  nonMember.addEventListener('click', orderOpen);
  function orderOpen() {
    nonmemberOrder.style.display = 'block';
  }
  var deliChk = document.getElementById('deli_chk');
  ...
  var infoBtn = document.getElementsByClassName('a02')[0];
  infoBtn.addEventListener('click', function () {
    if (document.getElementById('order_name02').value == '' || document.getElementById('order_tel02').value == '' || document.getElementById('order_email02').value == '' || document.getElementById('order_addr').value == '') {
      alert.style.display = 'block';
